...
for i,f in enumerate(os.listdir('data/adaptative_greedy_small')):
    rd_data, rd_best = read_file('data/adaptative_greedy_small/' + f)
    ax.bar(i, rd_data[0], 0.75, color=colors[i])
    print(rd_best)
...
plt.savefig('adaptative-greedy.pdf', bbox_inches='tight')
plt.savefig('adaptative-greedy.png', bbox_inches='tight')
