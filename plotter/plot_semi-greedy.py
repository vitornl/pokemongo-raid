...
for i,f in enumerate(os.listdir('data/semi_greedy_small/2')):
    rd_data, rd_best = read_file('data/semi_greedy_small/2/' + f)
    print(rd_best)
...
ax.set_zlabel('Occurrence over 1000 trials')

plt.savefig('semi-greedy-2.pdf', bbox_inches='tight')
plt.savefig('semi-greedy-2.png', bbox_inches='tight')
